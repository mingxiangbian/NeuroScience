...
assert.match(body, /route\.group\.visible = routeMode === mode/, "only the active responsive PCB route should remain visible");
...
assert.match(body, /connectorSide === "top" \? -1 : 1/, "top and bottom display connectors should fan out toward the screen body");
