#!/usr/bin/env python3
"""Independently verify the EXP-047 seed-43 formal execution gate."""
...
CONTRACT_ID = "EXP-047-FORMAL-SEED-43-V1"
VERIFICATION_ID = "EXP-047-FORMAL-SEED-43-GATE-VERIFY-V1"
STAGE = "formal-seed-43-train-only"
SCRIPT_DIR = Path(__file__).resolve().parent
PROJECT_ROOT = SCRIPT_DIR.parents[2]
REPO_ROOT = PROJECT_ROOT.parents[1]
CONTRACT_PATH = SCRIPT_DIR / "preflight" / "exp-047-formal-seed-43-contract-v1.json"
...
def build_verification(contract: dict[str, Any], completed_at_utc: str) -> dict[str, Any]:
    return {
        ...
        "next_required_step": "Bind this seed-43-only authorization and execute once; seed 44 and validation/test remain closed.",
