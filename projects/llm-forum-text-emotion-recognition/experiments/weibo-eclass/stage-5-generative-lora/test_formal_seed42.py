#!/usr/bin/env python3
"""Static and pure-function tests for the EXP-047 seed-42 formal runner."""
...
RUNNER_PATH = SCRIPT_DIR / "run_formal_seed42.py"
...
class FormalSeed42Tests(unittest.TestCase):
