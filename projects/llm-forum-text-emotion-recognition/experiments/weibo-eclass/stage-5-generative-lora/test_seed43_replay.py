#!/usr/bin/env python3
"""Pure-function tests for the EXP-047 seed-43 replay gate."""
...
RUNNER_PATH = SCRIPT_DIR / "run_seed43_replay.py"
SPEC = importlib.util.spec_from_file_location("exp047_seed43_replay", RUNNER_PATH)
if SPEC is None or SPEC.loader is None:
    raise RuntimeError("Unable to load replay runner")
RUNNER = importlib.util.module_from_spec(SPEC)
SPEC.loader.exec_module(RUNNER)
VERIFIER_PATH = SCRIPT_DIR / "verify_seed43_replay.py"
VERIFIER_SPEC = importlib.util.spec_from_file_location("exp047_seed43_replay_verifier", VERIFIER_PATH)
...
class Seed43ReplayTests(unittest.TestCase):
