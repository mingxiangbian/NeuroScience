#!/usr/bin/env python3
"""Static and pure-function tests for the EXP-047 seed-43 formal runner."""
...
RUNNER_PATH = SCRIPT_DIR / "run_formal_seed43.py"
...
class FormalSeed43Tests(unittest.TestCase):
