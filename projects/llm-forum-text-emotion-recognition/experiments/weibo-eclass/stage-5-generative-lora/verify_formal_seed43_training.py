#!/usr/bin/env python3
"""Independently verify the completed EXP-047 seed-43 train-only run."""
...
VERIFICATION_ID = "EXP-047-FORMAL-SEED-43-TRAIN-VERIFY-V1"
...
def verify_authorization(contract: dict[str, Any], report: dict[str, Any]) -> dict[str, Any]:
    ...
    expected = {
        ...
        "gate_verification_id": "EXP-047-FORMAL-SEED-43-GATE-VERIFY-V1",
    ...
    if (
        gate.get("verification_id") != "EXP-047-FORMAL-SEED-43-GATE-VERIFY-V1"
