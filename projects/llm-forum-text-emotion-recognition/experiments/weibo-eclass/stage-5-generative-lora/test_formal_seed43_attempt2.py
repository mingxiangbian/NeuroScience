#!/usr/bin/env python3
"""Static and pure-function tests for EXP-047 seed-43 attempt 2."""
...
RUNNER_PATH = SCRIPT_DIR / "run_formal_seed43_attempt2.py"
SPEC = importlib.util.spec_from_file_location("exp047_formal_seed43_attempt2_runner", RUNNER_PATH)
...
class FormalSeed43Attempt2Tests(unittest.TestCase):
