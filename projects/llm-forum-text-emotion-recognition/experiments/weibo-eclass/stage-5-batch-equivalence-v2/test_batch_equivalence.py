#!/usr/bin/env python3
"""Unit tests for the EXP-046 sampling, comparison, and decision helpers."""
...
SPEC = importlib.util.spec_from_file_location("exp046_runner", RUNNER_PATH)
...
class BatchEquivalenceTests(unittest.TestCase):
    def test_token_contract_accepts_only_integer_ids(self) -> None:
        self.assertEqual(RUNNER.require_token_ids([1, 2, 3]), [1, 2, 3])
        with self.assertRaises(TypeError):
            RUNNER.require_token_ids({"input_ids": [1, 2], "attention_mask": [1, 1]})
