#!/usr/bin/env python3
"""Run the preregistered EXP-009 RoBERTa-base fine-tuning experiment."""
...
DEFAULT_CONFIG = SCRIPT_DIR / "configs" / "exp-009-roberta-base.json"
DEFAULT_OUTPUT_DIR = SCRIPT_DIR / "runs" / "exp-009-roberta-base-finetuning"
REQUIREMENTS_LOCK = SCRIPT_DIR / "requirements-lock.txt"
PROTOCOL_PATH = (
    SCRIPT_DIR
    / "protocols"
    / "exp-009-roberta-base-finetuning.md"
)
EXPECTED_CONFIG_SHA256 = (
    "798bba6f9591fec3567140363aef189f99e8ac311d981ec66144fefeb807c06d"
)
EXPECTED_LOCK_SHA256 = (
    "123e455840fb9e5e9230cd3eb7feda625a8819c4cd3dbf82b91068a7d60797fd"
)
EXPECTED_PROTOCOL_SHA256 = (
    "d59648309b25088e828a04ae1f9288d41d9f25bc3958c4818cae635294eadf1b"
)
...
def save_confusion_figure(
    ...
    axis.set_title(f"EXP-009 Seed {seed} Validation")
    figure.tight_layout()
...
def main() -> None:
    ...
    with stdout_path.open("a", encoding="utf-8") as stdout_file:
        ...
        try:
            log("EXP-009 starting; test access is prohibited")
            ...
            log(
                "EXP-009 completed: mean validation Macro-F1 "
            ...
            write_json(run_path, run_state)
            log(f"EXP-009 failed: {type(error).__name__}: {error}")
            raise
        finally:
