...
class ContractTests(unittest.TestCase):
    ...
    def test_config_freezes_resource_gate_without_formal_authorization(self):
        config_path = MODULE_DIR / "configs/exp-053-m3-resource-preflight-seed-42.json"
    ...
    def test_frozen_config_and_prerequisite_schemas_are_accepted(self):
        ...
        self.assertEqual(m2_run["model_runtime"]["head_initial_sha256"], config["execution"]["expected_head_initial_sha256"])
