#!/usr/bin/env python3
"""Independently verify EXP-053 seed-43 Classification LoRA train+validation."""
...
def verify(config_path: Path, run_dir: Path) -> dict[str, Any]:
    ...
    check("seed44_sealed", config["authorization"].get("seed_44_authorized") is False)
    ...
    check("m2_seed43_completed", m2_run.get("status") == "Completed")
    check("m2_seed43_verified_99", passed_verification(m2_verify, 99))
