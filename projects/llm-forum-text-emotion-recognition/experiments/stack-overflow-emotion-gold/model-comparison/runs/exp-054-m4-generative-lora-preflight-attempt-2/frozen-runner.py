...
def run_preflight(config_path: Path) -> dict[str, Any]:
    ...
    del model, tokenizer, optimizer, loss_and_grad, all_sequences, initialized
    gc.collect()
    mx.clear_cache()
    ...
    run_record = {
        ...
        "model": {
            ...
            "insertion_count": first_model["insertion_count"],
            "trainable_parameter_count": first_model["trainable_parameter_count"],
            "lora_initial_sha256": first_model["lora_initial_sha256"],
        ...
        "resources": {
            ...
            "model_load_seconds": first_model["model_load_seconds"] + reloaded["model_load_seconds"],
