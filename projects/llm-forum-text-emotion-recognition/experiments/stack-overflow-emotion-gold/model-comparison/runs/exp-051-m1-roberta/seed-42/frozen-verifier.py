...
def verify() -> dict[str, Any]:
    ...
    check("seed authorization", config["authorization"]["seeds"] == [42] and args.seed == 42)
    ...
    check("future seeds sealed", config["authorization"]["seeds_43_44_authorized"] is False)
    ...
    check("memory budget", run["resource_usage"]["peak_mps_driver_gb"] <= config["execution"]["maximum_peak_memory_gb"])
