...
CONFIG_SCHEMA = "exp-065-label-free-projection-config-v1"
...
DEFAULT_CONFIG = PROJECT_ROOT / BASE / "configs/exp-065-label-free-validation-projection.json"
...
def verify(config_path: Path) -> dict[str, Any]:
    ...
    checks = [
        ...
        "exp064_prerequisite", "output_modes", "append_only_terminal_absence", "run_state",
        "public_privacy", "frozen_sources", "validation_row_schema", "sample_uniqueness",
